...
function showPopup(input,label) {                                                          
...
showPopup(usernameInput, usernameLabel);
showPopup(emailInput, emailLabel);
showPopup(idadeInput, idadeLabel);
showPopup(senhaInput, senhaLabel);
showPopup(confirmaSenhaInput, confirmaSenhaLabel);
